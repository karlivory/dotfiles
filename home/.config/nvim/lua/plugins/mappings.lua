    ...
    opts = {
      mappings = {
        ...
        n = {
          ...
          ["<C-1>"] = { function() require("astrocore.buffer").nav_to(1) end, desc = "go to tab 1" },
          ["<C-2>"] = { function() require("astrocore.buffer").nav_to(2) end, desc = "go to tab 2" },
          ...
          ["<C-0>"] = { function() require("astrocore.buffer").nav_to(10) end, desc = "go to tab 10" },
          ...
          ["\\"] = { function() vim.cmd("vsplit") end, desc = "vertical split" },
          ["|"] = { function() vim.cmd("close") end, desc = "close window" },
          ["<Leader>+o"] = { function() vim.cmd("only") end, desc = "close all other windows" },
          ["<C-X>"] = {
