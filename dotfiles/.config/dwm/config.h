...
static const char dmenufont[]            = { "UbuntuMono Nerd Font Mono:style=Regular:size=12" };
...
const char *spcmd1[] = {"st", "-n", "spterm1", "-g", "150x40", "-e", "ranger_wrapper", NULL };
...
static Key keys[] = {
	...
	/* { MODKEY|ShiftMask|ShiftMask,   XK_F6,         quit,                   {0} }, */
	#if RESTARTSIG_PATCH
	/* { MODKEY|ControlMask|ShiftMask, XK_F6,          quit,                   {1} }, */
	...
	#if FLEXTILE_DELUXE_LAYOUT
	/* { MODKEY|ControlMask,           XK_t,          rotatelayoutaxis,       {.i = +1 } },   /1* flextile, 1 = layout axis *1/ */
	/* { MODKEY|ControlMask,           XK_Tab,        rotatelayoutaxis,       {.i = +2 } },   /1* flextile, 2 = master axis *1/ */
	/* { MODKEY|ControlMask|ShiftMask, XK_Tab,        rotatelayoutaxis,       {.i = +3 } },   /1* flextile, 3 = stack axis *1/ */
	/* { MODKEY|ControlMask|Mod1Mask,  XK_Tab,        rotatelayoutaxis,       {.i = +4 } },   /1* flextile, 4 = secondary stack axis *1/ */
	...
	/* { MODKEY|Mod5Mask|ShiftMask,    XK_Tab,        rotatelayoutaxis,       {.i = -3 } },   /1* flextile, 3 = stack axis *1/ */
	/* { MODKEY|Mod5Mask|Mod1Mask,     XK_Tab,        rotatelayoutaxis,       {.i = -4 } },   /1* flextile, 4 = secondary stack axis *1/ */
	/* { MODKEY|ControlMask,           XK_Return,     mirrorlayout,           {0} },          /1* flextile, flip master and stack areas *1/ */
	#endif // FLEXTILE_DELUXE_LAYOUT
	/* { MODKEY,                       XK_F3,         setlayout,              {0} }, */
    ...
    // uncomment if I ever start using multiple monitors
	...
	#endif // BAR_TAGGRID_PATCH
	#if MOVEPLACE_PATCH
	/* { MODKEY,                       XK_KP_7,       moveplace,              {.ui = WIN_NW }},   /1* XK_KP_Home,  *1/ */
	/* { MODKEY,                       XK_KP_8,       moveplace,              {.ui = WIN_N  }},   /1* XK_KP_Up,    *1/ */
	/* { MODKEY,                       XK_KP_9,       moveplace,              {.ui = WIN_NE }},   /1* XK_KP_Prior, *1/ */
	/* { MODKEY,                       XK_KP_4,       moveplace,              {.ui = WIN_W  }},   /1* XK_KP_Left,  *1/ */
	/* { MODKEY,                       XK_KP_5,       moveplace,              {.ui = WIN_C  }},   /1* XK_KP_Begin, *1/ */
	/* { MODKEY,                       XK_KP_6,       moveplace,              {.ui = WIN_E  }},   /1* XK_KP_Right, *1/ */
	/* { MODKEY,                       XK_KP_1,       moveplace,              {.ui = WIN_SW }},   /1* XK_KP_End,   *1/ */
	/* { MODKEY,                       XK_KP_2,       moveplace,              {.ui = WIN_S  }},   /1* XK_KP_Down,  *1/ */
	/* { MODKEY,                       XK_KP_3,       moveplace,              {.ui = WIN_SE }},   /1* XK_KP_Next,  *1/ */
	#endif // MOVEPLACE_PATCH
	#if EXRESIZE_PATCH
	/* { MODKEY,                       XK_KP_7,       explace,                {.ui = EX_NW }},   /1* XK_KP_Home,  *1/ */
	/* { MODKEY,                       XK_KP_8,       explace,                {.ui = EX_N  }},   /1* XK_KP_Up,    *1/ */
	/* { MODKEY,                       XK_KP_9,       explace,                {.ui = EX_NE }},   /1* XK_KP_Prior, *1/ */
	/* { MODKEY,                       XK_KP_4,       explace,                {.ui = EX_W  }},   /1* XK_KP_Left,  *1/ */
	/* { MODKEY,                       XK_KP_5,       explace,                {.ui = EX_C  }},   /1* XK_KP_Begin, *1/ */
	/* { MODKEY,                       XK_KP_6,       explace,                {.ui = EX_E  }},   /1* XK_KP_Right, *1/ */
	/* { MODKEY,                       XK_KP_1,       explace,                {.ui = EX_SW }},   /1* XK_KP_End,   *1/ */
	/* { MODKEY,                       XK_KP_2,       explace,                {.ui = EX_S  }},   /1* XK_KP_Down,  *1/ */
	/* { MODKEY,                       XK_KP_3,       explace,                {.ui = EX_SE }},   /1* XK_KP_Next,  *1/ */

	/* { MODKEY|ShiftMask,             XK_KP_8,       exresize,               {.v = (int []){   0,  25 }}},  /1* XK_KP_Up,    *1/ */
	/* { MODKEY|ShiftMask,             XK_KP_2,       exresize,               {.v = (int []){   0, -25 }}},  /1* XK_KP_Down,  *1/ */
	/* { MODKEY|ShiftMask,             XK_KP_6,       exresize,               {.v = (int []){  25,   0 }}},  /1* XK_KP_Right, *1/ */
	/* { MODKEY|ShiftMask,             XK_KP_4,       exresize,               {.v = (int []){ -25,   0 }}},  /1* XK_KP_Left,  *1/ */
	/* { MODKEY|ShiftMask,             XK_KP_5,       exresize,               {.v = (int []){  25,  25 }}},  /1* XK_KP_Begin, *1/ */
	/* { MODKEY|ShiftMask|ControlMask, XK_KP_5,       exresize,               {.v = (int []){ -25, -25 }}},  /1* XK_KP_Begin, *1/ */

	/* { MODKEY|ControlMask,           XK_KP_6,       togglehorizontalexpand, {.i = +1} },  /1* XK_KP_Right, *1/ */
	/* { MODKEY|ControlMask,           XK_KP_3,       togglehorizontalexpand, {.i =  0} },  /1* XK_KP_Next,  *1/ */
	/* { MODKEY|ControlMask,           XK_KP_4,       togglehorizontalexpand, {.i = -1} },  /1* XK_KP_Left,  *1/ */
	/* { MODKEY|ControlMask,           XK_KP_8,       toggleverticalexpand,   {.i = +1} },  /1* XK_KP_Up,    *1/ */
	/* { MODKEY|ControlMask,           XK_KP_1,       toggleverticalexpand,   {.i =  0} },  /1* XK_KP_End,   *1/ */
	/* { MODKEY|ControlMask,           XK_KP_2,       toggleverticalexpand,   {.i = -1} },  /1* XK_KP_Down,  *1/ */
	/* { MODKEY|ControlMask,           XK_KP_9,       togglemaximize,         {.i = -1} },  /1* XK_KP_Prior, *1/ */
	/* { MODKEY|ControlMask,           XK_KP_7,       togglemaximize,         {.i = +1} },  /1* XK_KP_Home,  *1/ */
	/* { MODKEY|ControlMask,           XK_KP_5,       togglemaximize,         {.i =  0} },  /1* XK_KP_Begin, *1/ */
