...
kmap("n", "<leader>la",     "<cmd>lua vim.lsp.buf.code_action()<cr>", "Code action")
kmap("v", "<leader>la",     "<cmd>lua vim.lsp.buf.range_code_action()<cr>", "Code action (range)")
...
kmap("n", "<F6>",           ":lua require'dap'.set_breakpoint(nil, nil, vim.fn.input('Log point message: '))<CR>")
kmap("n", "<F7>",           ":lua require'dap'.set_breakpoint(vim.fn.input('Breakpoint condition: '))<CR>")
kmap("n", "<F8>",           ":lua require'dap'.toggle_breakpoint()<CR>")
kmap("n", "<F9>",           ":lua require'dap'.step_over()<CR>")
kmap("n", "<F10>",          ":lua require'dap'.step_into()<CR>")
kmap("n", "<F11>",          ":lua require'dap'.step_out()<CR>")
