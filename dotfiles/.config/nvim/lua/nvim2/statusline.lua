...
local setting_statusline = require('nvim2.settings').statusline
    ...
    if fn.winwidth(0) > 30 then
        ...
        if file_type ~= 'Help' then
            ...
            if setting_statusline.diagnostic_enabled then
                line = line
                    ...
                    .. [[ %{luaeval('require("nvim2.statusline").diagnostics_error()')}]]
                    .. '%#StatuslineDiagnosticsWarning#'
                    .. [[ %{luaeval('require("nvim2.statusline").diagnostics_warning()')}]]
                    .. '  '
            end
            ...
            if setting_statusline.git_diff_enabled then
                line = line
                    .. '%#StatuslineDiffAdded#'
                    .. [[ %{luaeval('require("nvim2.statusline").get_hunks_data()[1]')}]]
                    .. ' %#StatuslineDiffModified#'
                    .. [[ %{luaeval('require("nvim2.statusline").get_hunks_data()[2]')}]]
                    .. ' %#StatuslineDiffRemoved#'
                    .. [[ %{luaeval('require("nvim2.statusline").get_hunks_data()[3]')}]]
                    .. '  '
            end
            ...
            if setting_statusline.test_enabled and is_test_file() then
                line = line
                    .. '%#StatuslineTest#'
                    .. [[ %{luaeval('require("nvim2.statusline").tests()')}]]
                    .. '%#StatuslinePassed#'
                    .. [[ %{luaeval('require("nvim2.statusline").passed()')}]]
                    .. '%#StatuslineFailed#'
                    .. [[ %{luaeval('require("nvim2.statusline").failed()')}]]
                -- .. '%#StatuslineRunning#'
                -- .. [[ %{luaeval('require("nvim2.statusline").running()')}]]
            end
        end
        ...
        if is_update and fn.winwidth(0) > 80 then
            ...
            if setting_statusline.efm_enabled then
                line = line .. [[%{luaeval('require("nvim2.format").formatter_status()')}]]
            end
        end
