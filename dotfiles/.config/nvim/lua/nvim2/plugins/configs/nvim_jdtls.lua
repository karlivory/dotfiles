...
local config = {
  ...
  cmd = {
    ...
    "-jar",
    home .. "/.local/ls/java/jdtls/plugins/org.eclipse.equinox.launcher_1.6.400.v20210924-0641.jar",
    "-configuration",
    home .. "/.local/ls/java/jdtls/config_linux",
    "-data",
    home .. "/.local/share/jdtls_workspaces/" .. vim.fn.fnamemodify(root_dir, ":p:h:t"),
  },
  capabilities = {
    workspace = {
      configuration = true,
...
config.init_options = {
  bundles = {
    vim.fn.expand(
      home .. "/.local/ls/java/java-debug/com.microsoft.java.debug.plugin/target/com.microsoft.java.debug.plugin-*.jar"
    ),
  },
